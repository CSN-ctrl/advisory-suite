  ...
  <main className="pt-20">
    <section className="py-24 md:py-32 relative">
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
          ...
          >
            <p className="text-xs uppercase tracking-[0.3em] text-accent/70 font-body mb-4">About</p>
    ...
    <section className="py-20 md:py-28 relative bg-secondary/30 section-divider">
      <div className="container max-w-3xl">
        ...
        >
          <p className="text-foreground/90 italic border-l-2 border-accent/40 pl-6 text-lg">
